...
namespace Terraria
{
  public class NetMessage
  {
    ...
    public static void SendData(int msgType, int remoteClient = -1, int ignoreClient = -1, NetworkText text = null, int number = 0, float number2 = 0.0f, float number3 = 0.0f, float number4 = 0.0f, int number5 = 0, int number6 = 0, int number7 = 0)
    {
      ...
      try
      {
        Monitor.Enter((object) (messageBuffer = NetMessage.buffer[whoAmi]), ref flag1);
      ...
      {
        if (flag1)
          Monitor.Exit((object) messageBuffer);
      }
    }
    ...
    public static void ReceiveBytes(byte[] bytes, int streamLength, int i = 256)
    {
      ...
      try
      {
        Monitor.Enter((object) (messageBuffer = NetMessage.buffer[i]), ref flag);
        try
        {
    ...
    public static void CheckBytes(int bufferIndex = 256)
    {
      ...
      try
      {
        Monitor.Enter((object) (messageBuffer = NetMessage.buffer[bufferIndex]), ref flag);
        int startIndex = 0;
        ...
        {
          if (startIndex < NetMessage.buffer.Length - 100)
