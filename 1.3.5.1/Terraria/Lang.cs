...
namespace Terraria
{
  public class Lang
  {
    ...
    private static void FillNameCacheArray<IdClass, IdType>(string category, LocalizedText[] nameCache, bool leaveMissingEntriesBlank = false) where IdType : IConvertible
    {
      ...
      ((IEnumerable<FieldInfo>) Enumerable.Where<FieldInfo>((IEnumerable<M0>) typeof (IdClass).GetFields(BindingFlags.Static | BindingFlags.Public), (Func<M0, bool>) new Func<FieldInfo, bool>((object) null, __methodptr(\u003CFillNameCacheArray\u003Eb__7<IdClass, IdType>)))).ToList<FieldInfo>().ForEach((Action<FieldInfo>) (field =>
      {
    ...
    public static void InitializeLegacyLocalization()
    {
      ...
      FieldInfo[] fields = typeof (ItemID).GetFields(BindingFlags.Static | BindingFlags.Public);
      // ISSUE: reference to a compiler-generated field
      if (Lang.CS\u0024\u003C\u003E9__CachedAnonymousMethodDelegatef == null)
      {
        // ISSUE: reference to a compiler-generated field
        // ISSUE: method pointer
        Lang.CS\u0024\u003C\u003E9__CachedAnonymousMethodDelegatef = new Func<FieldInfo, bool>((object) null, __methodptr(\u003CInitializeLegacyLocalization\u003Eb__c));
      }
      // ISSUE: reference to a compiler-generated field
      Func<FieldInfo, bool> anonymousMethodDelegatef = Lang.CS\u0024\u003C\u003E9__CachedAnonymousMethodDelegatef;
      ((IEnumerable<FieldInfo>) Enumerable.Where<FieldInfo>((IEnumerable<M0>) fields, (Func<M0, bool>) anonymousMethodDelegatef)).ToList<FieldInfo>().ForEach((Action<FieldInfo>) (field =>
      {
