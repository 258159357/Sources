...
namespace Terraria.ObjectData
{
  public class TileObjectData
  {
    ...
    private List<TileObjectData> SubTiles
    {
      ...
      set
      {
        if (!this._hasOwnSubTiles)
        {
          ...
          this._subTiles = new TileObjectSubTilesModule((TileObjectSubTilesModule) null, (List<TileObjectData>) null);
        }
        if (value == null)
      ...
      set
      {
        ...
        if (!this._hasOwnTileObjectBase)
        {
          ...
          if (!this._hasOwnTileObjectCoords)
          {
            ...
            this._tileObjectCoords = new TileObjectCoordinatesModule(this._tileObjectCoords, (int[]) null);
    ...
    public static void Initialize()
    {
      ...
      TileObjectData.newTile.HookPlaceOverride = new PlacementHook(new Func<int, int, int, int, int, int>((object) null, __methodptr(PlaceXmasTree_Direct)), -1, 0, true);
      ...
      TileObjectData.newTile.CopyFrom(TileObjectData.Style2xX);
      // ISSUE: method pointer
      TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(new Func<int, int, int, int, int, int>((object) null, __methodptr(Hook_AfterPlacement)), -1, 0, false);
      TileObjectData.newTile.Direction = TileObjectDirection.PlaceLeft;
      TileObjectData.newTile.StyleMultiplier = 2;
      TileObjectData.newTile.StyleWrapLimit = 2;
      TileObjectData.newTile.DrawYOffset = 2;
      ...
      TileObjectData.newTile.CopyFrom(TileObjectData.Style3x2);
      // ISSUE: method pointer
      TileObjectData.newTile.HookCheck = new PlacementHook(new Func<int, int, int, int, int, int>((object) null, __methodptr(FindEmptyChest)), -1, 0, true);
      // ISSUE: method pointer
      TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(new Func<int, int, int, int, int, int>((object) null, __methodptr(AfterPlacement_Hook)), -1, 0, false);
      ...
      TileObjectData.newTile.StyleHorizontal = true;
      // ISSUE: method pointer
      TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(new Func<int, int, int, int, int, int>((object) null, __methodptr(Hook_AfterPlacement)), -1, 0, true);
      TileObjectData.newAlternate.CopyFrom(TileObjectData.newTile);
      TileObjectData.newAlternate.Origin = Point16.Zero;
      TileObjectData.newAlternate.AnchorTop = new AnchorData(AnchorType.SolidTile | AnchorType.SolidSide, 2, 0);
      TileObjectData.newAlternate.AnchorBottom = AnchorData.Empty;
    ...
    {
      NetMessage.SendData(17, -1, -1, (NetworkText) null, 1, (float) tileX, (float) tileY, (float) type, style, 0, 0);
    ...
    public static bool CallPostPlacementPlayerHook(int tileX, int tileY, int type, int style, int dir, TileObject data)
    {
      ...
      return postPlaceMyPlayer.hook.Invoke(tileX, tileY, type, style, dir) == postPlaceMyPlayer.badReturn;
    }
