      ...
      for (int index = 0; index < 6000; ++index)
      {
        ...
        if (!dust1.active)
        {
          ...
          while (num5 >= 100)
          {
            ...
            Rectangle& local1 = @dust1.frame;
            // ISSUE: explicit reference operation
            int num6 = (^local1).X - 1000;
            // ISSUE: explicit reference operation
            (^local1).X = (__Null) num6;
            // ISSUE: explicit reference operation
            // ISSUE: variable of a reference type
            Rectangle& local2 = @dust1.frame;
            // ISSUE: explicit reference operation
            int num7 = (^local2).Y + 30;
            // ISSUE: explicit reference operation
          ...
          if (dust1.type == 228 || dust1.type == 269 || (dust1.type == 135 || dust1.type == 6) || (dust1.type == 242 || dust1.type == 75 || (dust1.type == 169 || dust1.type == 29)) || (dust1.type >= 59 && dust1.type <= 65 || dust1.type == 158))
          {
            ...
            // ISSUE: explicit reference operation
            double num6 = (^local).X * 0.300000011920929;
            // ISSUE: explicit reference operation
            (^local).X = (__Null) num6;
            dust1.scale *= 0.7f;
          }
          ...
          if (dust1.active)
          {
            ...
            if ((dust1.type == 259 || dust1.type == 6 || dust1.type == 158) && (dust1.customData != null && dust1.customData is int))
            {
              ...
              else if ((int) dust1.customData == 1)
              {
                ...
                Vector2& local = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num2 = (^local).Y * 0.980000019073486;
                // ISSUE: explicit reference operation
                (^local).Y = (__Null) num2;
                if (Collision.SolidCollision(Vector2.op_Subtraction(dust1.position, Vector2.op_Multiply(Vector2.get_One(), 5f)), 10, 10) && (double) dust1.fadeIn == 0.0)
                {
            ...
            if (dust1.type == 213 || dust1.type == 260)
            {
              ...
              switch (dust1.type)
              {
                case 213:
                  // ISSUE: explicit reference operation
                  ((Vector3) @vector3).\u002Ector((float) byte.MaxValue, 217f, 48f);
                  break;
                case 260:
                  // ISSUE: explicit reference operation
                  ((Vector3) @vector3).\u002Ector((float) byte.MaxValue, 48f, 48f);
                  break;
              }
              vector3 = Vector3.op_Division(vector3, (float) byte.MaxValue);
              if ((double) num2 > 1.0)
                num2 = 1f;
              vector3 = Vector3.op_Multiply(vector3, num2);
              Lighting.AddLight((int) (dust1.position.X / 16.0), (int) (dust1.position.Y / 16.0), (float) vector3.X, (float) vector3.Y, (float) vector3.Z);
            }
            if (dust1.type == 157)
            {
            ...
            else if (dust1.type == 228 || dust1.type == 229 || (dust1.type == 6 || dust1.type == 242) || (dust1.type == 135 || dust1.type == (int) sbyte.MaxValue || (dust1.type == 187 || dust1.type == 75)) || (dust1.type == 169 || dust1.type == 29 || dust1.type >= 59 && dust1.type <= 65 || dust1.type == 158))
            {
              if (!dust1.noGravity)
              {
                ...
                Vector2& local = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num2 = (^local).Y + 0.0500000007450581;
                // ISSUE: explicit reference operation
                (^local).Y = (__Null) num2;
              }
            ...
            else if (dust1.type == 269)
            {
              ...
              if (dust1.customData != null && dust1.customData is Vector2)
              {
                ...
                Vector2& local = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num2 = (^local).X + 1.0 * (double) Math.Sign((float) vector2_2.X) * (double) dust1.scale;
                // ISSUE: explicit reference operation
                (^local).X = (__Null) num2;
              }
            }
            else if (dust1.type == 159)
            {
              ...
              else
              {
                ...
                // ISSUE: explicit reference operation
                double num3 = (^local1).X + (double) Main.rand.Next(-10, 11) * 0.0199999995529652;
                // ISSUE: explicit reference operation
                (^local1).X = (__Null) num3;
                // ISSUE: explicit reference operation
                // ISSUE: variable of a reference type
                ...
                // ISSUE: explicit reference operation
                double num4 = (^local2).Y + (double) Main.rand.Next(-10, 11) * 0.0199999995529652;
                // ISSUE: explicit reference operation
                (^local2).Y = (__Null) num4;
                if (Main.rand.Next(5) == 0)
                {
            ...
            else if (dust1.type == 164)
            {
              ...
              else
              {
                ...
                Vector2& local1 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num2 = (^local1).X + (double) Main.rand.Next(-10, 11) * 0.0199999995529652;
                // ISSUE: explicit reference operation
                ...
                Vector2& local2 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num3 = (^local2).Y + (double) Main.rand.Next(-10, 11) * 0.0199999995529652;
                // ISSUE: explicit reference operation
            ...
            else if (dust1.type == 173)
            {
              ...
              if (dust1.noGravity)
              {
                ...
                Vector2& local1 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num2 = (^local1).X + (double) Main.rand.Next(-20, 21) * 0.00999999977648258;
                // ISSUE: explicit reference operation
                (^local1).X = (__Null) num2;
                // ISSUE: explicit reference operation
                // ISSUE: variable of a reference type
                Vector2& local2 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num3 = (^local2).Y + (double) Main.rand.Next(-20, 21) * 0.00999999977648258;
                // ISSUE: explicit reference operation
                (^local2).Y = (__Null) num3;
                dust1.scale -= 0.01f;
              }
              else
              {
                ...
                Vector2& local1 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num2 = (^local1).X + (double) Main.rand.Next(-10, 11) * 0.00499999988824129;
                // ISSUE: explicit reference operation
                (^local1).X = (__Null) num2;
                // ISSUE: explicit reference operation
                // ISSUE: variable of a reference type
                Vector2& local2 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num3 = (^local2).Y + (double) Main.rand.Next(-10, 11) * 0.00499999988824129;
                // ISSUE: explicit reference operation
                (^local2).Y = (__Null) num3;
            ...
            else if (dust1.type == 160 || dust1.type == 162)
            {
              ...
              if (dust1.noGravity)
              {
                ...
                Vector2& local1 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num3 = (^local1).X + (double) Main.rand.Next(-20, 21) * 0.0399999991059303;
                // ISSUE: explicit reference operation
                (^local1).X = (__Null) num3;
                // ISSUE: explicit reference operation
                // ISSUE: variable of a reference type
                Vector2& local2 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num4 = (^local2).Y + (double) Main.rand.Next(-20, 21) * 0.0399999991059303;
                // ISSUE: explicit reference operation
                (^local2).Y = (__Null) num4;
                dust1.scale -= 0.1f;
              }
            ...
            else if (dust1.type >= 139 && dust1.type < 143)
            {
              ...
              Vector2& local1 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num2 = (^local1).X * 0.980000019073486;
              // ISSUE: explicit reference operation
              (^local1).X = (__Null) num2;
              // ISSUE: explicit reference operation
              // ISSUE: variable of a reference type
              Vector2& local2 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num3 = (^local2).Y * 0.980000019073486;
              // ISSUE: explicit reference operation
              (^local2).Y = (__Null) num3;
              if (dust1.velocity.Y < 1.0)
              {
                ...
                // ISSUE: explicit reference operation
                double num4 = (^local3).Y + 0.0500000007450581;
                // ISSUE: explicit reference operation
            ...
            else if (dust1.type == 14 || dust1.type == 16 || (dust1.type == 31 || dust1.type == 46) || (dust1.type == 124 || dust1.type == 186 || dust1.type == 188))
            {
              ...
              Vector2& local1 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num2 = (^local1).Y * 0.980000019073486;
              // ISSUE: explicit reference operation
              ...
              Vector2& local2 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num3 = (^local2).X * 0.980000019073486;
              // ISSUE: explicit reference operation
            ...
            else if (dust1.type == 32)
            {
              ...
              Vector2& local1 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num2 = (^local1).X * 0.959999978542328;
              // ISSUE: explicit reference operation
              (^local1).X = (__Null) num2;
              if (!dust1.noGravity)
              {
                ...
                Vector2& local2 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num3 = (^local2).Y + 0.100000001490116;
                // ISSUE: explicit reference operation
                (^local2).Y = (__Null) num3;
              }
            }
            else if (dust1.type >= 244 && dust1.type <= 247)
            {
              ...
              // ISSUE: explicit reference operation
              // ISSUE: explicit reference operation
              byte num2 = (byte) (((int) ((Color) @color).get_R() + (int) ((Color) @color).get_G() + (int) ((Color) @color).get_B()) / 3);
            ...
            else if (dust1.type == 20 || dust1.type == 21 || dust1.type == 231)
            {
              ...
              Vector2& local1 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num2 = (^local1).Y * 0.939999997615814;
              // ISSUE: explicit reference operation
              (^local1).Y = (__Null) num2;
              // ISSUE: explicit reference operation
              // ISSUE: variable of a reference type
              Vector2& local2 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num3 = (^local2).X * 0.939999997615814;
              // ISSUE: explicit reference operation
              (^local2).X = (__Null) num3;
            ...
            else if (dust1.type == 76)
            {
              ...
              if (!dust1.noLight && (double) y > 0.0)
              {
                // ISSUE: explicit reference operation
                // ISSUE: variable of a reference type
                Vector2& local = @dust1.position;
                // ISSUE: explicit reference operation
                double num2 = (^local).Y + Main.player[Main.myPlayer].velocity.Y * 0.200000002980232;
                // ISSUE: explicit reference operation
                (^local).Y = (__Null) num2;
              }
              if (Collision.SolidCollision(Vector2.op_Subtraction(dust1.position, Vector2.op_Multiply(Vector2.get_One(), 5f)), 10, 10) && (double) dust1.fadeIn == 0.0)
            ...
            else if (dust1.type == 268)
            {
              ...
              if (!dust1.noLight && (double) y > 0.0)
              {
                ...
                Vector2& local = @dust1.position;
                // ISSUE: explicit reference operation
                double num2 = (^local).Y + (double) y * 0.200000002980232;
                // ISSUE: explicit reference operation
                (^local).Y = (__Null) num2;
              }
              if (Collision.SolidCollision(Vector2.op_Subtraction(dust1.position, Vector2.op_Multiply(Vector2.get_One(), 5f)), 10, 10) && (double) dust1.fadeIn == 0.0)
            ...
            if (dust1.type == 33 || dust1.type == 52 || (dust1.type == 266 || dust1.type == 98) || (dust1.type == 99 || dust1.type == 100 || (dust1.type == 101 || dust1.type == 102)) || (dust1.type == 103 || dust1.type == 104 || (dust1.type == 105 || dust1.type == 123)))
            {
              ...
              if (dust1.noGravity)
              {
                ...
                Vector2& local1 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num2 = (^local1).X * 1.04999995231628;
                // ISSUE: explicit reference operation
                (^local1).X = (__Null) num2;
                // ISSUE: explicit reference operation
                // ISSUE: variable of a reference type
                Vector2& local2 = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num3 = (^local2).Y + 0.150000005960464;
                // ISSUE: explicit reference operation
                (^local2).Y = (__Null) num3;
              }
            }
            if (dust1.type == 35 && dust1.noGravity)
            {
              ...
              if ((double) dust1.scale < 1.0)
              {
                ...
                Vector2& local = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num2 = (^local).Y + 0.0750000029802322;
                // ISSUE: explicit reference operation
                (^local).Y = (__Null) num2;
              }
              // ISSUE: explicit reference operation
              ...
              Vector2& local1 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num3 = (^local1).X * 1.08000004291534;
              // ISSUE: explicit reference operation
              (^local1).X = (__Null) num3;
              if (dust1.velocity.X > 0.0)
            ...
            else if (dust1.type == 34 || dust1.type == 35 || dust1.type == 152)
            {
              ...
              else
              {
                ...
                Vector2& local = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num2 = (^local).X + (double) Main.rand.Next(-10, 10) * (1.0 / 500.0);
                // ISSUE: explicit reference operation
                (^local).X = (__Null) num2;
            ...
            if (dust1.type == 41)
            {
              ...
              Vector2& local1 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num2 = (^local1).X + (double) Main.rand.Next(-10, 11) * 0.00999999977648258;
              // ISSUE: explicit reference operation
              (^local1).X = (__Null) num2;
              // ISSUE: explicit reference operation
              // ISSUE: variable of a reference type
              Vector2& local2 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num3 = (^local2).Y + (double) Main.rand.Next(-10, 11) * 0.00999999977648258;
              // ISSUE: explicit reference operation
              (^local2).Y = (__Null) num3;
            ...
            else if (dust1.type == 44)
            {
              ...
              Vector2& local1 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num2 = (^local1).X + (double) Main.rand.Next(-10, 11) * (3.0 / 1000.0);
              // ISSUE: explicit reference operation
              (^local1).X = (__Null) num2;
              // ISSUE: explicit reference operation
              // ISSUE: variable of a reference type
              Vector2& local2 = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num3 = (^local2).Y + (double) Main.rand.Next(-10, 11) * (3.0 / 1000.0);
              // ISSUE: explicit reference operation
              (^local2).Y = (__Null) num3;
            ...
            else
            {
              ...
              Vector2& local = @dust1.velocity;
              // ISSUE: explicit reference operation
              double num2 = (^local).X * 0.990000009536743;
              // ISSUE: explicit reference operation
              (^local).X = (__Null) num2;
            }
            ...
            if (dust1.type >= 130 && dust1.type <= 134)
            {
              ...
              else if (dust1.type == 131)
              {
                ...
                Vector2& local = @dust1.velocity;
                // ISSUE: explicit reference operation
                double num3 = (^local).Y - 0.100000001490116;
                // ISSUE: explicit reference operation
                (^local).Y = (__Null) num3;
                dust1.scale += 1f / 400f;
              }
