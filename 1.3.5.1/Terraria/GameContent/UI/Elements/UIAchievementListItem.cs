  ...
  public class UIAchievementListItem : UIPanel
  {
    ...
    private Tuple<Decimal, Decimal> GetTrackerValues()
    {
      if (!this._achievement.HasTracker)
        return (Tuple<Decimal, Decimal>) Tuple.Create<Decimal, Decimal>((M0) new Decimal(0), (M1) new Decimal(0));
      ...
      if (tracker.GetTrackerType() == TrackerType.Int)
      {
        ...
        return (Tuple<Decimal, Decimal>) Tuple.Create<Decimal, Decimal>((M0) (Decimal) achievementTracker.Value, (M1) (Decimal) achievementTracker.MaxValue);
      }
      if (tracker.GetTrackerType() != TrackerType.Float)
        return (Tuple<Decimal, Decimal>) Tuple.Create<Decimal, Decimal>((M0) new Decimal(0), (M1) new Decimal(0));
      AchievementTracker<float> achievementTracker1 = (AchievementTracker<float>) tracker;
      return (Tuple<Decimal, Decimal>) Tuple.Create<Decimal, Decimal>((M0) (Decimal) achievementTracker1.Value, (M1) (Decimal) achievementTracker1.MaxValue);
    }
