...
namespace Terraria.GameContent.UI.States
{
  public class UIVirtualKeyboard : UIState
  {
    ...
    private void BuildSpaceBarArea(UIPanel mainPanel)
    {
      ...
      UIVirtualKeyboard.\u003C\u003Ec__DisplayClass2a cDisplayClass2a = new UIVirtualKeyboard.\u003C\u003Ec__DisplayClass2a();
      // ISSUE: reference to a compiler-generated field
      cDisplayClass2a.mainPanel = mainPanel;
      // ISSUE: reference to a compiler-generated field
      cDisplayClass2a.\u003C\u003E4__this = this;
      // ISSUE: reference to a compiler-generated field
      // ISSUE: method pointer
      cDisplayClass2a.createTheseTwo = new Action((object) cDisplayClass2a, __methodptr(\u003CBuildSpaceBarArea\u003Eb__26));
      // ISSUE: reference to a compiler-generated field
      cDisplayClass2a.createTheseTwo.Invoke();
      if (!this.CanRestore())
        return;
      ...
      restoreBar.OnClick += (UIElement.MouseEvent) ((evt, listeningElement) =>
      {
        ...
        createTheseTwo.Invoke();
      });
      // ISSUE: reference to a compiler-generated field
      cDisplayClass2a.mainPanel.Append((UIElement) restoreBar);
    ...
    public static void Cancel()
    {
      if (UIVirtualKeyboard._currentInstance == null)
        return;
      Main.PlaySound(11, -1, -1, 1, 1f, 0.0f);
      UIVirtualKeyboard._currentInstance._cancelAction.Invoke();
    }
