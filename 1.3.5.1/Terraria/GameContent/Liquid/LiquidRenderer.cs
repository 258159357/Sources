  ...
  public class LiquidRenderer
  {
    ...
    public event Action<Color[], Rectangle> WaveFilters
    {
      add
      {
        ...
        Action<Color[], Rectangle> comparand;
        do
        {
          comparand = action;
          action = Interlocked.CompareExchange<Action<Color[], Rectangle>>(ref this.WaveFilters, (Action<Color[], Rectangle>) Delegate.Combine((Delegate) comparand, (Delegate) value), comparand);
        }
      ...
      remove
      {
        ...
        {
          comparand = action;
          action = Interlocked.CompareExchange<Action<Color[], Rectangle>>(ref this.WaveFilters, (Action<Color[], Rectangle>) Delegate.Remove((Delegate) comparand, (Delegate) value), comparand);
        }
        while (action != comparand);
      }
    }
