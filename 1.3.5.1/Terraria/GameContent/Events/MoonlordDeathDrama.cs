  ...
  public class MoonlordDeathDrama
  {
    ...
    public class MoonlordPiece
    {
      ...
      public void Update()
      {
        ...
        Vector2& local = @this._velocity;
        // ISSUE: explicit reference operation
        double num = (^local).Y + 0.300000011920929;
        // ISSUE: explicit reference operation
        (^local).Y = (__Null) num;
        this._rotation += this._rotationVelocity;
        this._rotationVelocity *= 0.99f;
        MoonlordDeathDrama.MoonlordPiece moonlordPiece = this;
        Vector2 vector2 = Vector2.op_Addition(moonlordPiece._position, this._velocity);
        moonlordPiece._position = vector2;
      }
