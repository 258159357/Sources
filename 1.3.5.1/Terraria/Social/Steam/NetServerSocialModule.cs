...
namespace Terraria.Social.Steam
{
  public class NetServerSocialModule : NetSocialModule
  {
    ...
    {
      if (!this._connectionStateMap.ContainsKey(userId) || this._connectionStateMap.get_Item(userId) == NetSocialModule.ConnectionState.Inactive)
      {
      ...
      NetSocialModule.ConnectionState connectionState = this._connectionStateMap.get_Item(userId);
      ...
      {
        case 0:
          this._connectionStateMap.set_Item(userId, NetSocialModule.ConnectionState.Connected);
    ...
    private void OnP2PSessionRequest(P2PSessionRequest_t result)
    {
      ...
      if (this._connectionStateMap.ContainsKey(steamIdRemote) && this._connectionStateMap.get_Item(steamIdRemote) != NetSocialModule.ConnectionState.Inactive)
      {
      ...
      else
      {
        ...
        this._connectionStateMap.set_Item(steamIdRemote, NetSocialModule.ConnectionState.Authenticating);
