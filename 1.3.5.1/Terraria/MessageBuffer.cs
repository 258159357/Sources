      ...
      else
      {
        ...
        switch (num1)
        {
          ...
          case 5:
            ...
            try
            {
              Monitor.Enter((object) (player4 = player3), ref flag2);
          ...
          case 12:
            ...
            if (Main.netMode == 2)
              index3 = this.whoAmI;
            Player player5 = Main.player[index3];
          ...
          case 13:
            ...
            if (Main.netMode == 2)
              number7 = this.whoAmI;
            Player player6 = Main.player[number7];
            BitsByte bitsByte9 = (BitsByte) this.reader.ReadByte();
            player6.controlUp = bitsByte9[0];
            player6.controlDown = bitsByte9[1];
            player6.controlLeft = bitsByte9[2];
            player6.controlRight = bitsByte9[3];
            player6.controlJump = bitsByte9[4];
            player6.controlUseItem = bitsByte9[5];
            player6.direction = bitsByte9[6] ? 1 : -1;
            BitsByte bitsByte10 = (BitsByte) this.reader.ReadByte();
            if (bitsByte10[0])
            {
              player6.pulley = true;
              player6.pulleyDir = bitsByte10[1] ? (byte) 2 : (byte) 1;
            }
            else
              player6.pulley = false;
            player6.selectedItem = (int) this.reader.ReadByte();
            player6.position = this.reader.ReadVector2();
            if (bitsByte10[2])
              player6.velocity = this.reader.ReadVector2();
            else
              player6.velocity = Vector2.get_Zero();
            player6.vortexStealthActive = bitsByte10[3];
            player6.gravDir = bitsByte10[4] ? 1f : -1f;
            ...
            for (int index1 = num21; index1 < num21 + (int) num19; ++index1)
            {
              for (int index2 = num22; index2 < num22 + (int) num19; ++index2)
              {
                ...
                if (tile.active())
                {
                  ...
                  else if (!flag3 || (int) tile.type != type1)
                  {
                    tile.frameX = (short) -1;
                    tile.frameY = (short) -1;
                  }
          ...
          case 90:
            ...
            if (Main.netMode == 1)
            {
              ...
              bool flag3 = (obj.newAndShiny || obj.netID != type4) && ItemSlot.Options.HighlightNewItems && (type4 < 0 || type4 >= 3930 || !ItemID.Sets.NeverShiny[type4]);
          ...
          case 30:
            ...
            Main.player[number14].hostile = flag9;
            if (Main.netMode != 2)
              break;
          ...
          case 33:
            ...
            if (Main.netMode == 1)
            {
              ...
              else if (player9.chest != num34 && num34 != -1)
              {
                Main.playerInventory = true;
                Main.PlaySound(12, -1, -1, 1, 1f, 0.0f);
                Main.recBigList = false;
              }
              else if (player9.chest != -1 && num34 == -1)
              {
          ...
          case 36:
            ...
            player10.zone1 = (BitsByte) this.reader.ReadByte();
            player10.zone2 = (BitsByte) this.reader.ReadByte();
            player10.zone3 = (BitsByte) this.reader.ReadByte();
            player10.zone4 = (BitsByte) this.reader.ReadByte();
            if (Main.netMode != 2)
              break;
          ...
          case 41:
            ...
            player11.itemRotation = num38;
            player11.itemAnimation = num39;
          ...
          case 48:
            ...
            try
            {
              Monitor.Enter((object) (tile2 = Main.tile[i1, j1]), ref flag10);
          ...
          case 91:
            ...
            try
            {
              Monitor.Enter((object) (byId = EmoteBubble.byID), ref flag11);
              if (!EmoteBubble.byID.ContainsKey(key2))
              {
          ...
          case 96:
            ...
            player16.lastPortalColorIndex = num76;
          ...
          case 102:
            ...
            for (int index1 = 0; index1 < (int) byte.MaxValue; ++index1)
            {
              ...
              {
                Vector2 vector2_8 = Vector2.op_Subtraction(player17.Center, player9.Center);
                ...
                if (!vec.HasNaNs())
                {
                  ...
                  {
                    Vector2 Position = Vector2.op_Addition(Vector2.op_Addition(Vector2.op_Addition(player9.Center, Vector2.op_Multiply(6f * (float) index2, vec)), spinningpoint.RotatedBy((double) num2, (Vector2) null)), vector2_11);
                    num2 += num47;
                ...
                player9.NebulaLevelup((int) num78);
              }
            }
            break;
          case 103:
          ...
          case 110:
            ...
            for (int index1 = 0; index1 < num85; ++index1)
              player18.ConsumeItem(type13, false);
          ...
          case 117:
            ...
            bool flag12 = bitsByte20[0];
            bool pvp1 = bitsByte20[1];
            int num89 = (int) this.reader.ReadSByte();
            Main.player[playerTargetIndex1].Hurt(playerDeathReason1, num87, num88, pvp1, true, flag12, num89);
            if (Main.netMode != 2)
              break;
            NetMessage.SendPlayerHurt(playerTargetIndex1, playerDeathReason1, num87, num88, flag12, pvp1, num89, -1, this.whoAmI);
            break;
          case 118:
