...
namespace Terraria.ID
{
  public class TileID
  {
    ...
    public static class Sets
    {
      ...
      public static bool[] HasSlopeFrames = TileID.Sets.Factory.CreateBoolSet(new int[2]
      {
        421,
        422
      });
      ...
      public static bool[] GeneralPlacementTiles = TileID.Sets.Factory.CreateBoolSet(1 != 0, 225, 41, 43, 44, 226, 203, 112, 25, 70, 151, 21, 31, 467, 12);
