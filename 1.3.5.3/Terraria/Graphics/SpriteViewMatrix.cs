...
namespace Terraria.Graphics
{
  public class SpriteViewMatrix
  {
    ...
    private void Rebuild()
    {
      ...
      Vector2 vector2_3 = vector2_2 / zoom;
      Vector2 vector2_4 = vector2_2 - vector2_3;
      this._translation = vector2_4;
      this._zoomMatrix = Matrix.CreateTranslation(-vector2_4.X, -vector2_4.Y, 0.0f) * Matrix.CreateScale(this._zoom.X, this._zoom.Y, 1f);
