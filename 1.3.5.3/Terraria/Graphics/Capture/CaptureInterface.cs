...
namespace Terraria.Graphics.Capture
{
  public class CaptureInterface
  {
      ...
      for (int index = 0; index < num1; ++index)
      {
        if (new Rectangle(24 + 46 * index, 24, 42, 42).Contains(mouse.ToPoint()))
        {
          ...
          if (num7 == num8 && flag2 && (CaptureInterface.EdgeAPinned && CaptureInterface.EdgeBPinned))
          {
            ...
            CaptureBiome biome = CaptureBiome.Biomes[CaptureInterface.Settings.BiomeChoice];
            settings.Biome = biome;
            int num11 = !CaptureInterface.Settings.TransparentBackground ? 1 : 0;
            settings.CaptureBackground = num11 != 0;
            int num12 = CaptureInterface.Settings.IncludeEntities ? 1 : 0;
            settings.CaptureEntities = num12 != 0;
            int num13 = CaptureInterface.Settings.PackImage ? 1 : 0;
            settings.UseScaling = num13 != 0;
            int num14 = WiresUI.Settings.DrawWires ? 1 : 0;
            settings.CaptureMech = num14 != 0;
          ...
          if (num15 == num16 && flag2 && this.SelectedMode != 0)
          {
            this.SelectedMode = 0;
          ...
          if (num19 == num20 && flag2 && this.SelectedMode != 1)
          {
            this.SelectedMode = 1;
            this.ToggleCamera(true);
          }
          ...
          if (num23 == num24 && flag2)
            CaptureInterface.ResetFocus();
          int num27 = index;
          int num28 = num26;
          int num29 = 1;
          int num30 = num28 + num29;
          if (num27 == num28 && flag2 && Main.mapEnabled)
            Main.mapFullscreen = !Main.mapFullscreen;
          int num31 = index;
          int num32 = num30;
          int num33 = 1;
          int num34 = num32 + num33;
          if (num31 == num32 && flag2 && this.SelectedMode != 2)
          {
            this.SelectedMode = 2;
            this.ToggleCamera(true);
          }
    ...
    public static void QuickScreenshot()
    {
      ...
      CaptureSettings settings = new CaptureSettings();
      settings.Area = new Rectangle(tileCoordinates1.X, tileCoordinates1.Y, tileCoordinates2.X - tileCoordinates1.X + 1, tileCoordinates2.Y - tileCoordinates1.Y + 1);
      settings.Biome = CaptureBiome.Biomes[CaptureInterface.Settings.BiomeChoice];
      int num1 = !CaptureInterface.Settings.TransparentBackground ? 1 : 0;
      settings.CaptureBackground = num1 != 0;
      int num2 = CaptureInterface.Settings.IncludeEntities ? 1 : 0;
      settings.CaptureEntities = num2 != 0;
      int num3 = CaptureInterface.Settings.PackImage ? 1 : 0;
      settings.UseScaling = num3 != 0;
      int num4 = WiresUI.Settings.DrawWires ? 1 : 0;
      settings.CaptureMech = num4 != 0;
      CaptureInterface.StartCamera(settings);
    }
    ...
    private static bool GetMapCoords(int PinX, int PinY, int Goal, out Point result)
    {
      ...
      {
        float num23 = num16 * 0.999f;
        num19 = num17 - 40.6f * num23;
        num20 = y2 - 5f * num23;
        num21 = (width - 8.045f) * num23;
        float num24 = (height + 0.12f) * num23;
        if ((double) num23 < 1.2)
          num22 = num24 + 1f;
      }
      else if (Main.maxTilesX == 6400)
      {
        float num23 = num16 * 1.09f;
        num19 = num17 - 38.8f * num23;
        num20 = y2 - 3.85f * num23;
        num21 = (width - 13.6f) * num23;
      ...
      {
        float num23 = num16 * 1.09f;
        num19 = num17 - 39.8f * num23;
        num20 = y2 - 4.08f * num23;
        num21 = (width - 26.69f) * num23;
        float num24 = (height - 6.92f) * num23;
        if ((double) num23 < 1.2)
          num22 = num24 + 2f;
      }
      ...
      {
        float num23 = num16 * 0.998f;
        num19 = num17 - 37.3f * num23;
        num20 = num18 - 1.7f * num23;
        num21 = (width - 16f) * num23;
        num22 = (height - 8.31f) * num23;
      }
      if (Goal == 0)
      {
    ...
    public void Scrolling()
    {
      ...
      this.SelectedMode = this.SelectedMode - num;
      while (this.SelectedMode < 0)
        this.SelectedMode = this.SelectedMode + 2;
    ...
    private class ModeEdgeSelection : CaptureInterface.CaptureInterfaceMode
    {
      ...
      private void DrawCursors(SpriteBatch sb)
      {
        ...
        if (!CaptureInterface.EdgeBPinned)
        {
          Utils.DrawCursorSingle(sb, white, 0.7853981f, Main.cursorScale * num1 * num2, new Vector2((float) ((double) Main.mouseX + 2.5 + 12.0), (float) ((double) Main.mouseY - 5.0 + 12.0)), 5, 0);
        }
        else
        {
          int specialMode = 0;
    ...
    private class ModeDragBounds : CaptureInterface.CaptureInterfaceMode
    {
      ...
      private void DragBounds(Vector2 mouse)
      {
        ...
        if (this.currentAim != -1)
        {
          ...
          int currentAim = this.currentAim;
          if ((uint) currentAim > 1U)
          {
            if ((uint) (currentAim - 2) <= 1U)
            {
