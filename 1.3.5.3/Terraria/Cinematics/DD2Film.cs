  ...
  public class DD2Film : Film
  {
    ...
    private void CreateCritters(FrameEventData evt)
    {
      for (int index = 0; index < 5; ++index)
      {
        ...
        NPC npc = this.PlaceNPCOnGround((int) Utils.SelectRandom<short>(Main.rand, new short[4]{ (short) 46, (short) 46, (short) 299, (short) 538 }), this._startPoint + new Vector2((float) (((double) num - 0.25) * 400.0 + (double) Main.rand.NextFloat() * 50.0 - 25.0), 0.0f));
        npc.ai[0] = 0.0f;
        npc.ai[1] = 600f;
