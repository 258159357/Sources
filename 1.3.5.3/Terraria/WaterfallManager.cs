  ...
  public class WaterfallManager
  {
    ...
    private void DrawWaterfall(SpriteBatch spriteBatch, int Style = 0, float Alpha = 1f)
    {
      ...
      for (int index1 = 0; index1 < this.currentMax; ++index1)
      {
            ...
            if (!Main.drewLava)
            {
              ...
              if (this.waterfalls[index1].stopAtStep != 0 && (double) (y + num17) >= (double) Main.screenPosition.Y / 16.0 && ((double) x1 >= (double) Main.screenPosition.X / 16.0 - 1.0 && (double) x1 <= ((double) Main.screenPosition.X + (double) Main.screenWidth) / 16.0 + 1.0))
              {
                ...
                for (int index4 = 0; index4 < num17; ++index4)
                {
                  ...
                  Color color2 = color1 * (float) num23;
                  double num24 = (double) num21;
                  Color color3 = color1 * (float) num24;
                  if (index2 == 22)
                  {
        ...
        int num25 = 0;
        int num26 = this.waterfallDist;
        Color color4 = Color.White;
        for (int index4 = 0; index4 < num26; ++index4)
        {
          if (num25 < 2)
          {
            switch (index2)
            {
              case 1:
                ...
                double num18 = 0.300000011920929;
                float G1 = (float) (num17 * num18);
                double num19 = 0.100000001490116;
                float B1 = (float) (num17 * num19);
                Lighting.AddLight(x1, y, R1, G1, B1);
                break;
              case 2:
                float num20 = (float) Main.DiscoR / (float) byte.MaxValue;
                float num21 = (float) Main.DiscoG / (float) byte.MaxValue;
                float num22 = (float) Main.DiscoB / (float) byte.MaxValue;
                float R2 = num20 * 0.2f;
                float G2 = num21 * 0.2f;
                float B2 = num22 * 0.2f;
            ...
            Color color1 = Lighting.GetColor(x1, y);
            Color color2 = color1;
            float num31 = index2 != 1 ? (index2 != 14 ? ((int) tile.wall != 0 || (double) y >= Main.worldSurface ? 0.6f * Alpha : Alpha) : 0.8f) : 1f;
            if (index4 > num26 - 10)
              num31 *= (float) (num26 - index4) / 10f;
            float num32 = (float) color1.R * num31;
            float num33 = (float) color1.G * num31;
            float num34 = (float) color1.B * num31;
            float num35 = (float) color1.A * num31;
            if (index2 == 1)
            {
              if ((double) num32 < 190.0 * (double) num31)
                num32 = 190f * num31;
              if ((double) num33 < 190.0 * (double) num31)
                num33 = 190f * num31;
              if ((double) num34 < 190.0 * (double) num31)
                num34 = 190f * num31;
            }
            else if (index2 == 2)
            {
              num32 = (float) Main.DiscoR * num31;
              num33 = (float) Main.DiscoG * num31;
              num34 = (float) Main.DiscoB * num31;
            }
            else if (index2 >= 15 && index2 <= 21)
            {
              num32 = (float) byte.MaxValue * num31;
              num33 = (float) byte.MaxValue * num31;
              num34 = (float) byte.MaxValue * num31;
            }
            color1 = new Color((int) num32, (int) num33, (int) num34, (int) num35);
            if (index2 == 1)
            {
              float num36 = Math.Abs((float) (x1 * 16 + 8) - (Main.screenPosition.X + (float) (Main.screenWidth / 2)));
              float num37 = Math.Abs((float) (y * 16 + 8) - (Main.screenPosition.Y + (float) (Main.screenHeight / 2)));
              if ((double) num36 < (double) (Main.screenWidth * 2) && (double) num37 < (double) (Main.screenHeight * 2))
              {
                float num38 = (float) (1.0 - Math.Sqrt((double) num36 * (double) num36 + (double) num37 * (double) num37) / ((double) Main.screenWidth * 0.75));
                if ((double) num38 > 0.0)
                  num6 += num38;
              }
              if ((double) num36 < (double) num7)
              {
                num7 = num36;
                num9 = x1 * 16 + 8;
              }
              if ((double) num37 < (double) num8)
              {
                num8 = num36;
                num10 = y * 16 + 8;
              }
            ...
            else if (index2 != 1 && index2 != 14 && (index2 != 11 && index2 != 12) && index2 != 22)
            {
              ...
              if ((double) num36 < (double) num2)
              {
                num2 = num36;
                num4 = x1 * 16 + 8;
              }
              if ((double) num37 < (double) num3)
              {
                num3 = num36;
                num5 = y * 16 + 8;
              }
            ...
            {
              float num36 = (float) color2.R;
              if ((double) color2.G > (double) num36)
                num36 = (float) color2.G;
              if ((double) color2.B > (double) num36)
                num36 = (float) color2.B;
              if ((double) Main.rand.Next(20000) < (double) num36 / 30.0)
              {
            ...
            if (num12 == 0 && num24 != 0 && (num13 == 1 && num14 != num15))
            {
              num24 = 0;
              num14 = num15;
              color1 = Color.White;
              if (num14 == 1)
                spriteBatch.Draw(this.waterfallTexture[index2], new Vector2((float) (x1 * 16 - 16), (float) (y * 16 + 16)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 24, 32, 16 - num23)), color1, 0.0f, Vector2.Zero, 1f, SpriteEffects.FlipHorizontally, 0.0f);
              else
            ...
            if (num16 != 0 && num28 == 0 && num29 == 1)
            {
              if (num14 == 1)
              {
                if (index3 != index2)
                  spriteBatch.Draw(this.waterfallTexture[index3], new Vector2((float) (x1 * 16), (float) (y * 16 + num11 + 8)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 0, 16, 16 - num23 - 8)), color4, 0.0f, Vector2.Zero, 1f, SpriteEffects.FlipHorizontally, 0.0f);
                else
                  spriteBatch.Draw(this.waterfallTexture[index2], new Vector2((float) (x1 * 16), (float) (y * 16 + num11 + 8)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 0, 16, 16 - num23 - 8)), color1, 0.0f, Vector2.Zero, 1f, SpriteEffects.FlipHorizontally, 0.0f);
              }
              else
                spriteBatch.Draw(this.waterfallTexture[index2], new Vector2((float) (x1 * 16), (float) (y * 16 + num11 + 8)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 0, 16, 16 - num23 - 8)), color1, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
            }
            ...
            if (num24 != 0 && num12 == 0)
            {
              ...
              {
                if (index3 != index2)
                  spriteBatch.Draw(this.waterfallTexture[index3], new Vector2((float) (x1 * 16 - 16), (float) (y * 16)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 24, 32, 16 - num23)), color4, 0.0f, new Vector2(), 1f, SpriteEffects.FlipHorizontally, 0.0f);
                else
                  spriteBatch.Draw(this.waterfallTexture[index2], new Vector2((float) (x1 * 16 - 16), (float) (y * 16)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 24, 32, 16 - num23)), color1, 0.0f, new Vector2(), 1f, SpriteEffects.FlipHorizontally, 0.0f);
              }
              else if (index3 != index2)
                spriteBatch.Draw(this.waterfallTexture[index3], new Vector2((float) (x1 * 16), (float) (y * 16)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 24, 32, 16 - num23)), color4, 0.0f, new Vector2(), 1f, SpriteEffects.None, 0.0f);
              else
                spriteBatch.Draw(this.waterfallTexture[index2], new Vector2((float) (x1 * 16), (float) (y * 16)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 24, 32, 16 - num23)), color1, 0.0f, new Vector2(), 1f, SpriteEffects.None, 0.0f);
            }
            if (num29 == 1 && num24 == 0 && num16 == 0)
            {
              if (num14 == -1)
              {
                if (num13 == 0)
                  spriteBatch.Draw(this.waterfallTexture[index2], new Vector2((float) (x1 * 16), (float) (y * 16 + num11)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 0, 16, 16 - num23)), color1, 0.0f, new Vector2(), 1f, SpriteEffects.None, 0.0f);
                else if (index3 != index2)
                  spriteBatch.Draw(this.waterfallTexture[index3], new Vector2((float) (x1 * 16), (float) (y * 16)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 24, 32, 16 - num23)), color4, 0.0f, new Vector2(), 1f, SpriteEffects.None, 0.0f);
                else
                  spriteBatch.Draw(this.waterfallTexture[index2], new Vector2((float) (x1 * 16), (float) (y * 16)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 24, 32, 16 - num23)), color1, 0.0f, new Vector2(), 1f, SpriteEffects.None, 0.0f);
                ...
                spriteBatch.Draw(this.waterfallTexture[index2], new Vector2((float) (x1 * 16), (float) (y * 16 + num11)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 0, 16, 16 - num23)), color1, 0.0f, new Vector2(), 1f, SpriteEffects.FlipHorizontally, 0.0f);
              else if (index3 != index2)
                spriteBatch.Draw(this.waterfallTexture[index3], new Vector2((float) (x1 * 16 - 16), (float) (y * 16)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 24, 32, 16 - num23)), color4, 0.0f, new Vector2(), 1f, SpriteEffects.FlipHorizontally, 0.0f);
              else
                spriteBatch.Draw(this.waterfallTexture[index2], new Vector2((float) (x1 * 16 - 16), (float) (y * 16)) - Main.screenPosition, new Rectangle?(new Rectangle(x2, 24, 32, 16 - num23)), color1, 0.0f, new Vector2(), 1f, SpriteEffects.FlipHorizontally, 0.0f);
              ...
              if ((int) Main.tile[x1, y].liquid <= 0 || Main.tile[x1, y].halfBrick())
              {
                if (num24 == 1)
                {
                  for (int index5 = 0; index5 < 8; ++index5)
                  {
                    ...
                    if (num12 == 0 && index5 < 2)
                      num38 = 4;
                    spriteBatch.Draw(this.waterfallTexture[index2], new Vector2((float) (x1 * 16 + num36), (float) (y * 16 + num11 + num38)) - Main.screenPosition, new Rectangle?(new Rectangle(16 + x2 + num37, 0, 2, 16 - num11)), color1, 0.0f, new Vector2(), 1f, SpriteEffects.FlipHorizontally, 0.0f);
                  }
                }
                else
            ...
            if (testTile1.active() && ((int) testTile1.type == 189 || (int) testTile1.type == 196) || testTile3.active() && ((int) testTile3.type == 189 || (int) testTile3.type == 196) || testTile2.active() && ((int) testTile2.type == 189 || (int) testTile2.type == 196))
              num26 = (int) ((double) (40 * (Main.maxTilesX / 4200)) * (double) Main.gfxQuality);
          }
        }
      }
