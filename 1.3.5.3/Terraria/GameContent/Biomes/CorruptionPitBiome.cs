...
namespace Terraria.GameContent.Biomes
{
  public class CorruptionPitBiome : MicroBiome
  {
    ...
    public override bool Place(Point origin, StructureMap structures)
    {
      ...
      WorldUtils.Gen(origin, (GenShape) new ModShapes.All(shapeData1), Actions.Chain((GenAction) new Modifiers.IsTouchingAir(true), (GenAction) new Modifiers.NotTouching(0 != 0, new ushort[1]
      {
        (ushort) 25
