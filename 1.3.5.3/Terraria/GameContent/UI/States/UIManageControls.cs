...
namespace Terraria.GameContent.UI.States
{
  public class UIManageControls : UIState
  {
    ...
    private void SetupGamepadPoints(SpriteBatch spriteBatch)
    {
      ...
      Vector2 minimum = clippingRectangle.TopLeft() * num15;
      Vector2 maximum = clippingRectangle.BottomRight() * num15;
      ...
      for (int index7 = 0; index7 < snapPoints.Count; ++index7)
      {
        ...
        if (snapPoints[index7].Name == "Thin")
        {
          ...
          int num16 = ID2 + 1;
          point7.Right = num16;
          int num17 = index7 < snapPoints.Count - 2 ? ID2 + 2 : ID1;
          point7.Down = num17;
          int num18 = index7 < 2 ? ID1 + 1 : (snapPoints[index7 - 1].Name == "Wide" ? ID2 - 1 : ID2 - 2);
          point7.Up = num18;
          ...
          if (index7 < snapPoints.Count)
          {
            ...
            int num19 = ID3 - 1;
            point8.Left = num19;
            int num20 = index7 < snapPoints.Count - 1 ? (snapPoints[index7 + 1].Name == "Wide" ? ID3 + 1 : ID3 + 2) : ID1;
            point8.Down = num20;
            int num21 = index7 < 2 ? ID1 + 1 : ID3 - 2;
            point8.Up = num21;
        ...
        else
        {
          ...
          point7.Unlink();
          UILinkPointNavigator.SetPosition(ID2, snapPoints[index7].Position);
          int num16 = index7 < snapPoints.Count - 1 ? ID2 + 1 : ID1;
          point7.Down = num16;
          int num17 = index7 < 1 ? ID1 + 1 : (snapPoints[index7 - 1].Name == "Wide" ? ID2 - 1 : ID2 - 2);
          point7.Up = num17;
          UILinkPointNavigator.Shortcuts.FANCYUI_HIGHEST_INDEX = ID2;
          UILinkPointNavigator.Points[ID1].Up = ID2;
        }
