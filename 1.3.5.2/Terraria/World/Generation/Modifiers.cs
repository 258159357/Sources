  ...
  public static class Modifiers
  {
    ...
    public class HasLiquid : GenAction
    {
      ...
      public override bool Apply(Point origin, int x, int y, params object[] args)
      {
        ...
        if ((this._liquidType == -1 || this._liquidType == (int) tile.liquidType()) && (this._liquidLevel == -1 && (int) tile.liquid != 0 || this._liquidLevel == (int) tile.liquid))
          return this.UnitApply(origin, x, y, args);
        return this.Fail();
      }
    }
    ...
    public class Offset : GenAction
    {
      ...
      public override bool Apply(Point origin, int x, int y, params object[] args)
      {
        return this.UnitApply(origin, x + this._xOffset, y + this._yOffset, args);
      }
    }
