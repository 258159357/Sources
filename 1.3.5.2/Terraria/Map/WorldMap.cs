...
namespace Terraria.Map
{
  public class WorldMap
  {
    ...
    {
      return (int) this._tiles[x, y].Light > 0;
    }
    ...
    public bool UpdateType(int x, int y)
    {
      ...
      if (mapTile.Equals(this._tiles.Address(x, y)))
        return false;
      this._tiles[x, y] = mapTile;
      return true;
    }
    ...
    public void Load()
    {
      ...
      if (isCloudSave && SocialAPI.Cloud == null || !Main.mapEnabled)
        return;
      string str1 = Main.playerPathName.Substring(0, Main.playerPathName.Length - 4) + (object) Path.DirectorySeparatorChar;
      string str2;
