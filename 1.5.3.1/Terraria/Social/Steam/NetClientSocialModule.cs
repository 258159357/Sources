...
namespace Terraria.Social.Steam
{
  public class NetClientSocialModule : NetSocialModule
  {
    ...
    public override void Initialize()
    {
      ...
      // ISSUE: method pointer
      Main.OnEngineLoad += new Action((object) this, __methodptr(CheckParameters));
    }
    ...
    private void CheckParameters()
    {
      ...
      if (!((CSteamID) @lobbySteamId).IsValid())
        return;
    ...
    public override void LaunchLocalServer(Process process, ServerMode mode)
    {
      ...
      // ISSUE: method pointer
      Netplay.OnDisconnect += new Action((object) this, __methodptr(OnDisconnect));
      process.Start();
    }
    ...
    {
      if (this._hasLocalHost || this._lobby.State == LobbyState.Active || (long) Main.LobbyId != 0L)
    ...
    private void OnLobbyEntered(LobbyEnter_t result, bool failure)
    {
      ...
      this._connectionStateMap.set_Item(this._lobby.Owner, NetSocialModule.ConnectionState.Connected);
