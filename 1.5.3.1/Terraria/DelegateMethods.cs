  ...
  public static class DelegateMethods
  {
    ...
    public static class Minecart
    {
      ...
      public static void Sparks(Vector2 dustPosition)
      {
        ...
        // ISSUE: explicit reference operation
        double num1 = (^local1).X * ((double) Main.rand.Next(25, 101) * 0.00999999977648258);
        // ISSUE: explicit reference operation
        ...
        // ISSUE: explicit reference operation
        double num2 = (^local2).Y - (double) Main.rand.Next(15, 31) * 0.100000001490116;
        // ISSUE: explicit reference operation
        (^local2).Y = (__Null) num2;
        // ISSUE: explicit reference operation
        // ISSUE: variable of a reference type
        Vector2& local3 = @Main.dust[index].position;
        // ISSUE: explicit reference operation
        double num3 = (^local3).Y - 4.0;
        // ISSUE: explicit reference operation
