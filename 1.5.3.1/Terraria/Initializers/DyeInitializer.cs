      ...
      GameShaders.Hair.BindShader<LegacyHairShaderData>(1984, new LegacyHairShaderData().UseLegacyMethod((LegacyHairShaderData.ColorProcessingMethod) ((Player player, Color newColor, ref bool lighting) =>
      {
        ...
        if (!Main.gameMenu && !Main.gamePaused)
        {
          if (Main.rand.Next(45) == 0)
          {
            ...
            // ISSUE: explicit reference operation
            double num1 = (^local1).X * (1.0 + (double) Main.rand.Next(-50, 51) * 0.00999999977648258);
            // ISSUE: explicit reference operation
            ...
            // ISSUE: explicit reference operation
            double num2 = (^local2).Y * (1.0 + (double) Main.rand.Next(-50, 51) * 0.00999999977648258);
            // ISSUE: explicit reference operation
            ...
            // ISSUE: explicit reference operation
            double num3 = (^local3).X + (double) Main.rand.Next(-50, 51) * 0.00999999977648258;
            // ISSUE: explicit reference operation
            (^local3).X = (__Null) num3;
            // ISSUE: explicit reference operation
            // ISSUE: variable of a reference type
            Vector2& local4 = @Main.dust[index].velocity;
            // ISSUE: explicit reference operation
            double num4 = (^local4).Y + (double) Main.rand.Next(-50, 51) * 0.00999999977648258;
            // ISSUE: explicit reference operation
            (^local4).Y = (__Null) num4;
            // ISSUE: explicit reference operation
            // ISSUE: variable of a reference type
            Vector2& local5 = @Main.dust[index].velocity;
            // ISSUE: explicit reference operation
            double num5 = (^local5).Y - 1.0;
            // ISSUE: explicit reference operation
            (^local5).Y = (__Null) num5;
          ...
          if (Main.rand.Next(225) == 0)
          {
            ...
            // ISSUE: explicit reference operation
            // ISSUE: variable of a reference type
            Vector2& local1 = @Main.gore[index].velocity;
            // ISSUE: explicit reference operation
            double num1 = (^local1).X * (1.0 + (double) Main.rand.Next(-50, 51) * 0.00999999977648258);
            // ISSUE: explicit reference operation
            (^local1).X = (__Null) num1;
            // ISSUE: explicit reference operation
            // ISSUE: variable of a reference type
            Vector2& local2 = @Main.gore[index].velocity;
            // ISSUE: explicit reference operation
            double num2 = (^local2).Y * (1.0 + (double) Main.rand.Next(-50, 51) * 0.00999999977648258);
            // ISSUE: explicit reference operation
            (^local2).Y = (__Null) num2;
            ...
            // ISSUE: explicit reference operation
            // ISSUE: variable of a reference type
            Vector2& local3 = @Main.gore[index].velocity;
            // ISSUE: explicit reference operation
            double num3 = (^local3).X + (double) Main.rand.Next(-50, 51) * 0.00999999977648258;
            // ISSUE: explicit reference operation
            (^local3).X = (__Null) num3;
            // ISSUE: explicit reference operation
            // ISSUE: variable of a reference type
            Vector2& local4 = @Main.gore[index].velocity;
            // ISSUE: explicit reference operation
            double num4 = (^local4).Y + (double) Main.rand.Next(-50, 51) * 0.00999999977648258;
            // ISSUE: explicit reference operation
            (^local4).Y = (__Null) num4;
            // ISSUE: explicit reference operation
            // ISSUE: variable of a reference type
            Vector2& local5 = @Main.gore[index].velocity;
            // ISSUE: explicit reference operation
            double num5 = (^local5).Y - 1.0;
            // ISSUE: explicit reference operation
            (^local5).Y = (__Null) num5;
